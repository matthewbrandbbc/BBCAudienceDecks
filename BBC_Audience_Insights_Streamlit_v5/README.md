...
The no-API assistant also supports follow-up questions, two-way audience or region comparisons, contextual question suggestions, typo-tolerant metric matching, claim-strength labels and a transparent directional sales opportunity score.
...
The dashboard places a grounded sales overview above the slide preview and an
**Ask the Audience AI** question bar beneath the overview.
